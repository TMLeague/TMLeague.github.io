...
public class HouseScoreTests
{
    ...
    {
        var baratheon = new HouseScore(House.Baratheon, "Bara", 1, 2, 3, 2, 5, 1, 0, 2, 0, 0, Array.Empty<int>(), new HouseStats());
        var lannister = new HouseScore(House.Lannister, "Lanni", 2, 3, 1, 2, 5, 1, 0, 2, 0, 0, Array.Empty<int>(), new HouseStats());
        var stark = new HouseScore(House.Stark, "Star", 3, 1, 2, 1, 5, 1, 1, 2, 0, 0, Array.Empty<int>(), new HouseStats());
